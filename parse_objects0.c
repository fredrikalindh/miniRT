...
/*   Updated: 2020/01/12 19:58:03 by frlindh          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_sp(char **s, int i)
{
	...
	while (s && s[++i] != NULL)
		free(s[i]);
	if (shell->check != 0 && (i != 8|| g_rt.err != 0))
		ft_puterr2('h');
	return (0);
}

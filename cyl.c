...
/*   Updated: 2020/01/12 19:32:23 by frlindh          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				hit_cy(t_intersection *i, t_ray ray, void *shape)
{
	...
	t_vector temp1 = cross(cy->dir, vector_xyz(1, 0, 0));
	i->uv.x = 0.5 + (atan2(dot(temp1, i->normal), dot(cross(cy->dir, temp1), i->normal)) * 0.159159);
